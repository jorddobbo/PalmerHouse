...
<section class="home-hero">
	<div class="home-hero__container container">
		<div class="home-hero__content">
			<h2 class="home-hero__title">Welcome to Palmer House</h2>
			<div class="home-hero__sub-title">CO-SPACING & WELLBEING CENTRE</div>
		</div>
	</div>

	<div class="home-hero__image">
		<div class="home-hero__img" style="background-image: url('<?= get_template_directory_uri(); ?>/assets/img/home/home-one.jpg');"></div>
		<div class="home-hero__img" style="background-image: url('<?= get_template_directory_uri(); ?>/assets/img/home/home-two.jpg');"></div>
		<div class="home-hero__img" style="background-image: url('<?= get_template_directory_uri(); ?>/assets/img/home/home-one.jpg');"></div>
	</div>
	<!-- <div class="home-hero__arrows"></div> -->
</section>

<section class="home-intro">
	<div class="home-intro__container container">
		<div class="home-intro__top">
			<p class="home-intro__paragraph">We offer attractive and affordable rooms for hire to counsellors and therapists. If you are a practitioner in the therapy world and are looking for a place to work from in the central Nottingham area then come and have a look.</p>
		</div>
	</div>
</section>
